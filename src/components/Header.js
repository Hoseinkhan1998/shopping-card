    ...
    return (
        <header>
            <nav className='flex justify-between items-center h-12 px-4 shadow-md bg-gray-800 text-white'>
                ...
                <div>
                    <span className=' absolute font-bold text-orange-600 ml-4 mt-1 text-center w-4'>
                    ...
                    {!loading && cartItems.length > 0 && pathname !== '/cart' && (
                        <div className='w-0 h-0 border-8 border-solid border-transparent border-r-gray-300
